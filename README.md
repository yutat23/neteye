...
[![CI](https://github.com/example/neteye/workflows/CI/badge.svg)](https://github.com/example/neteye/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/example/neteye)](https://goreportcard.com/report/github.com/example/neteye)
...
Download the appropriate binary for your platform from [Releases](https://github.com/example/neteye/releases):

```bash
# Linux/macOS
curl -fsSL https://github.com/example/neteye/releases/latest/download/neteye-linux-amd64.tar.gz | tar -xz
sudo mv neteye /usr/local/bin/

# Windows (PowerShell)
Invoke-WebRequest -Uri "https://github.com/example/neteye/releases/latest/download/neteye-windows-amd64.zip" -OutFile "neteye.zip"
...
```bash
git clone https://github.com/example/neteye
cd neteye
...
```bash
go install github.com/example/neteye/cmd/neteye@latest
```

### Homebrew (macOS/Linux)

```bash
brew install example/tools/neteye
```

### Docker

```bash
docker run --rm ghcr.io/example/neteye:latest version
```
